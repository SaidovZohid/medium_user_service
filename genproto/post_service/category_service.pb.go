...
var file_category_service_proto_rawDesc = []byte{
	...
	0xf6, 0x01, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76,
...
var file_category_service_proto_depIdxs = []int32{
	...
	0, // 4: genproto.CategoryService.Create:output_type -> genproto.Category
	0, // 5: genproto.CategoryService.Get:output_type -> genproto.Category
	0, // 6: genproto.CategoryService.Update:output_type -> genproto.Category
	2, // 7: genproto.CategoryService.Delete:output_type -> google.protobuf.Empty
